// ============================================================
// PrintPadi – lib/productsApi.ts
// Client-side port of app/actions/products.ts from the Next.js
// project. The original is a Next.js Server Action ("use server",
// unstable_cache, server-only) — none of that exists in a Vite/
// Capacitor app, so this is the same fetch + normalization logic
// running directly in the browser via apiClient's getApiBaseUrl().
// ============================================================
...
export const fetchAllProductsAction = () => fetchProductsFromEndpoint('/products');

export const fetchRetailProductsAction = () => fetchProductsFromEndpoint('/products/retail');

export const fetchBulkProductsAction = () => fetchProductsFromEndpoint('/products/bulk');

export const fetchChinaProductsAction = () => fetchProductsFromEndpoint('/products?origin=CHINA');
