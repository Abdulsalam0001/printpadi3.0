// ============================================================
// PrintPadi – features/cart/components/slider-form.tsx
// Exact port of slider-form.tsx from the Next.js project.
// (next/image → plain <img>, @/features/cart/store → @/store/cartStore)
// ============================================================
    ...
    <div className="mx-4">
      <div className="flex items-stretch w-full space-x-2.5">
        <div className="px-4 py-0.75 rounded-[2.56px]">
          <img src={primaryImageOrFallback} alt="" width={55} height={55} />
        </div>
