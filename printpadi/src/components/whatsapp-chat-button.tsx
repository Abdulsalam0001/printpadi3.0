// ============================================================
// PrintPadi – WhatsAppChatButton
// Exact port of components/whatsapp-chat-button.tsx
// (process.env → import.meta.env for Vite)
// ============================================================
...
const DEFAULT_MISSING_PHONE_MESSAGE =
  'WhatsApp contact is not configured. Set VITE_WHATSAPP_PHONE_NUMBER.';
...
export type WhatsAppChatButtonProps = {
   ...
   * VITE_WHATSAPP_PHONE_NUMBER from the client bundle.
   */
  phoneNumber?: string;
  label?: string;
  className?: string;
...
export const WhatsAppChatButton = ({
  ...
  const raw = phoneNumber ?? import.meta.env.VITE_WHATSAPP_PHONE_NUMBER ?? '';
