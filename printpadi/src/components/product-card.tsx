// ============================================================
// PrintPadi – components/product-card.tsx
// Exact port of components/product-card.tsx from the Next.js project.
// (next/image → plain <img>, next/link → react-router-dom Link)
// ============================================================
...
import { saveCurrentScrollPositionForReturn } from '@/lib/scrollRestoration';
  ...
  return (
    <div className="relative z-10 w-full">
      <Link
        ...
        onClick={saveCurrentScrollPositionForReturn}
      />
      <div
        ...
        >
          ...
          {variation == 'primary' &&
            (details.type == 'retail' ? (
              ...
              <p className={cn('text-xs font-sans italic', {})}>
                {displayMoq} moq{' '}
              </p>
            ))}
